...
interface ContratoDesenvolvedor {
    interface View{
        ...
        fun preencheCamposDev(desenvolvedor: Desenvolvedor)
    ...
    interface Presenter {
        ...
        fun criarDesenvolvedor(
            _nome: String, _sobrenome: String, _email: String,
            _senha: String, _cpf: String, _endereco: Endereco,
            _numero: String, _complemento: String
        )
        fun atualizaDesenvolvedor(uid: String, _nome : String, _sobrenome : String, _email : String,
                                  _senha : String, _cpf : String, _endereco : Endereco,
                                  _numero : String, _complemento: String)
        ...
        //exibe mensagens
        fun exibeToast(_msg: String)
        fun trazDesenvolvedor(uid : String)
        fun preencheCamposDev(desenvolvedor: Desenvolvedor)
    ...
    interface Interactor{
        ...
        fun atualizaDesenvolvedor( _desenvolvedor: Desenvolvedor)
        fun trazDesenvolvedor(uid : String)
    }
}